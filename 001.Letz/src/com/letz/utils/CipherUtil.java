...
/**
 * @Class Name : CipherUtil.java
 * @Description : �븫蹂듯샇�솕 Util(SEED-CBC 128bit)
 * @author UZEN / �씠�슜�꽑
 * @since 2015. 11. 24.
 * @version 1.0
 * @see
...
public class CipherUtil {
    ...
    private static final String DEFAULT_IV = "jAJu201511241714";

    /**
     * seed濡� �븫�샇�솕�맂 臾몄옄�뿴�쓣 蹂듯샇�솕
     * 
     * @param encVal
     *            - �븫�샇�솕 ���긽 string
     * @return
     * @throws Exception
     */
    public static String decStr(String encVal) throws Exception {

        // �븫�샇�솕臾� byte 諛곗뿴 由ъ뒪�듃濡� 蹂��솚
        List<byte[]> encByteList = getByteList(encVal, true);

        // 蹂듯샇�솕�맂 byte 諛곗뿴 ���옣�븷 由ъ뒪�듃 �꽑�뼵
        ...
        for (int i = 0; i < encByteList.size(); i++) {
            ...
            // 蹂듯샇�솕 �궎
            int[] seedKey = CipherUtil.getSeedRoundKey("4J6ZcT5OTRE+MZHQ");

            CipherUtil.SeedDecrypt(encByte, seedKey, tempDecByte);
     ...
     * @throws Exception
     */
    public static String encStr(String strVal) throws Exception {

        // �썝臾몄쓣 byte[] list濡� 蹂��솚
        List<byte[]> byteList = getByteList(strVal, false);

        // �븫�샇�솕�맂 byte[]瑜� ���옣�븷 list
        ...
        for (int i = 0; i < byteList.size(); i++) {
            ...
            CipherUtil.SeedEncrypt(byteVal, seedKey, tempEncVal);

            byteIV = tempEncVal;
            encByteList.add(tempEncVal);
        }

        // list�뿉 �떞湲� enc臾몄쓣 str�삎�깭濡� 蹂��솚�븯�뿬 諛섑솚
        return getByteListStr(encByteList, true);
    }

    /**
     * �븫/蹂듯샇�솕�뿉 �궗�슜�븷 key媛믪쓣 �깮�꽦
     * 
     * @param keyStr
     *            - �깮�꽦�븷 key媛믪쓽 string 媛�
     * @return
     * @throws Exception
     */
    public static int[] getSeedRoundKey(String keyStr) throws Exception {
        ...
        CipherUtil.SeedRoundKey(seedKey, keyStr.getBytes());

        return seedKey;
    }

    /**
     * CBC �슫�쁺紐⑤뱶瑜� �궗�슜�븯湲� �쐞�븳 XOR �뿰�궛 硫붿꽌�뱶
     * value1怨� value2瑜� OXR �뿰�궛 �썑 洹� 寃곌낵瑜� value1�뿉 �떞�뒗�떎.
     * 128bit �솗�젙�삎
     * 
     * @param value1
     *            - 蹂��닔1
    ...
    /**
     * seed�뒗 128bit 釉붾줉 �떒�쐞濡� �븫�샇�솕 泥섎━�븳�떎.
     * 臾몄옄�뿴�쓣 128bit�떒�쐞濡� byte諛곗뿴�쓣 �깮�꽦�븯怨�, 洹� 諛곗뿴�쓣 list�삎�깭濡� 諛섑솚�븳�떎.
     * 
     * @param nomal
     * @param isDecode
     * @return
    ...
    private static List<byte[]> getByteList(String nomal, boolean isDecode) throws Exception {
        ...
        if (isDecode) {
            tempByte = Base64.decodeBase64(nomal);
        } else {
            tempByte = nomal.getBytes(CHARACTER_SET);
        }

        // seed �븫�샇�솕瑜� �쐞�빐�꽑 byte媛� 臾댁“嫄� 16byte�뵫 諛곗뿴�씠 �깮�꽦�릺�뼱�빞 �븿�쑝濡� 鍮덈같�뿴�쓽 怨듦컙�닔瑜� 怨꾩궛
        int needBlankLength = 0;
        if (tempByte.length % 16 != 0) {
            needBlankLength = 16 - (tempByte.length % 16);
        }

        // �쐞�뿉�꽌 援ы븳 �븘�슂�븳 鍮덇났媛꾩쓽 �닔瑜� �뜑�븯�뿬 �떎�떆 諛곗뿴 �깮�꽦
        ...
        // �씠�젣 newTempByte瑜� 16�쓽 諛곗닔�쓽 �궗�씠利덈�� 媛뽯뒗 諛곗뿴�씠 �릺�뿀�떎.
        // 16媛쒖뵫 吏ㅻ씪�꽌 List�뿉 add �븳�떎.
        int inListByteIdx = 0;
    ...
    /**
     * 128bit�떒�쐞濡� 履쇨컻吏� byte諛곗뿴�씠 �떞湲� list瑜� 臾몄옄�뿴濡� 蹂��솚�빐以��떎
     * 
     * @param byteList
     * @param isEncode
     * @return
    ...
    private static String getByteListStr(List<byte[]> byteList, boolean isEncode) throws Exception {
        ...
        // List�뿉 �떞湲� byte諛곗뿴�씠 16�쑝濡� 怨좎젙�엫�쑝濡� * 16
        byte[] listByte = new byte[byteList.size() * 16];

        // List�뿉 �떞湲� byte諛곗뿴�쓣 �븯�굹�쓽 諛곗뿴(listByte)�뿉 merge
        for (int i = 0; i < byteList.size(); i++) {
        ...
        if (isEncode) {
            ...
            retStr = Base64.encodeBase64String(resultByte);
