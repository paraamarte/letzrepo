package com.letz.utils.common.mybatis;
...
/**
 * org.mybatis.spring.SqlSessionFactoryBean�뿉 error 濡쒓렇 異붽�
 */
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean,
    ...
    /**
     * Set the MyBatis TransactionFactory to use. Default is {@code SpringManagedTransactionFactory} The default
     * {@code SpringManagedTransactionFactory} should be appropriate for all cases:
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        if (xmlConfigBuilder != null) {
            try {
                ...
                logger.error("Failed to parse config resource: " + this.configLocation + " " + ex.toString());
        ...
        if (this.databaseIdProvider != null) {
            try {
                ...
                logger.error("Failed getting a databaseId " + e.toString());
        ...
        if (!isEmpty(this.mapperLocations)) {
            for (Resource mapperLocation : this.mapperLocations) {
                ...
                try {
                    ...
                    logger.error(mapperLocation + " " + e.toString());
